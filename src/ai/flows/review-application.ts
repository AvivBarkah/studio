...
const reviewApplicationPromptObj = ai.definePrompt({
  ...
  prompt: `You are an AI assistant tasked with reviewing student application forms for a madrasah. Your goal is to help human administrators by checking for completeness.
...
3.  Write 'feedbackNotes' for the administrator, detailing any missing information or other concerns. Be specific.
4.  List any 'actionItems' for the administrator (e.g., "Verify NISN if provided but seems incorrect", "Follow up on missing address details").
5.  Indicate if the application 'needsHumanAttention' (true/false) based on the severity of any issues found. An incomplete application warrants human attention.
