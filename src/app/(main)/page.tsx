...
import { FileText, ListChecks, HelpCircle, ArrowRight, ClipboardCheck } from "lucide-react";
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <Card className="text-center card-hover-effect">
            <CardHeader>
              ...
              <CardTitle className="font-headline text-xl">Verifikasi & Seleksi</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription>
                Data Anda akan diverifikasi oleh tim kami dan Anda akan mengikuti proses seleksi.
              </CardDescription>
            </CardContent>
          </Card>
          <Card className="text-center card-hover-effect">
